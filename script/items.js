...
export let itemsArr = [
    ...
    new Item('Calçola microfibra adulto', 'pictures/image-140055.jpeg', 'calcinha', 6.5),
    new Item('Calça cinta pala dupla', 'pictures/image-150055.jpeg', 'calcinha', 20),
    ...
    new Item('Calça algodão infantil Suede', 'pictures/image-260055.jpeg', 'calcinha', 5),
    new Item('Calça infantil microfibra', 'pictures/image-270055.jpeg', 'calcinha', 4),
    new Item('Tanga microfibra', 'pictures/image-280055.jpeg', 'tanga', 6),
    new Item('Calça infantil semaninha - Kit', 'pictures/image-290055.jpeg', 'calcinha', 32),
    ...
    new Item('Calça lateral com renda', 'pictures/image-380055.jpeg', 'calcinha', 8.5),
    ...
    new Item('Calça coton cós virado', 'pictures/image-430055.jpeg', 'calcinha', 7),
    ...
    new Item('Calça plus reforçada', 'pictures/image-480055.jpeg', 'calcinha', 18),
    new Item('Fio rendado', 'pictures/image-490055.jpeg', 'fio', 7.5),
    new Item('Calça drapeada', 'pictures/image-500055.jpeg', 'calcinha', 8.5),
    new Item('Calça infantil algodão', 'pictures/image-520055.jpeg', 'calcinha', 5),
    new Item('Calça infantil microfibra', 'pictures/image-530055.jpeg', 'calcinha', 5),
    ...
    new Item('Calça cinta', 'pictures/image-560055.jpeg', 'calcinha', 21),
    ...
    new Item('Calça pala microfibra', 'pictures/image-650055.jpeg', 'calcinha', 8.5),
    ...
    new Item('Calça franzida microfibra', 'pictures/image-770055.jpeg', 'calcinha', 7),
    ...
    new Item('Calça microfibra plus', 'pictures/image-910055.jpeg', 'calcinha', 11),
    ...
    new Item('Calça infantil algodão', 'pictures/image-101.jpeg', 'calcinha', 5.7),
...
export function filterItems(category){
  if(category === 'todos'){
    let arrayToReturn = JSON.parse(localStorage.getItem('arrayItems')) || itemsArr;
