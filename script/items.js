...
export let itemsArr = [
    ...
    new Item('Calça cós', 'pictures/image-030055.jpeg', 'calça', 4.5),
    new Item('Tanga algodão', 'pictures/image-040055.jpeg', 'tanga', 6),
    new Item('Modelador macaquinho', 'pictures/image-050055.jpeg', 'modelador', 57),
    new Item('Calça infantil luxo', 'pictures/image-060055.jpeg', 'calça', 8),
    ...
    new Item('Calça pala microfibra', 'pictures/image-130055.jpeg', 'calça', 8.5),
    new Item('Calçola microfibra adulto', 'pictures/image-140055.jpeg', 'calça', 6.5),
    new Item('Calça cinta pala dupla', 'pictures/image-150055.jpeg', 'calça', 20),
    new Item('Calça renda frente', 'pictures/image-160055.jpeg', 'calça', 8.5),
    new Item('Sutiã duplo', 'pictures/image-170055.jpeg', 'sutiã', 22),
    new Item('Calça cinta', 'pictures/image-180055.jpeg', 'calça', 27),
    new Item('Fio largo', 'pictures/image-200055.jpeg', 'fio', 8.5),
    new Item('Sutiã top microfibra sem bojo', 'pictures/image-210055.jpeg', 'sutiã', 28.5),
    ...
    new Item('Cueca box poliamida', 'pictures/image-250055.jpeg', 'cueca', 11),
    new Item('Calça algodão infantil Suede', 'pictures/image-260055.jpeg', 'calça', 5),
    new Item('Calça infantil microfibra', 'pictures/image-270055.jpeg', 'calça', 4),
    new Item('Tanga microfibra', 'pictures/image-280055.jpeg', 'tanga', 6),
    new Item('Calça infantil semaninha - Kit', 'pictures/image-290055.jpeg', 'calça', 32),
    ...
    new Item('Sutiã top com bojo removível', 'pictures/image-330055.jpeg', 'sutiã', 20),
    new Item('Camisola cava Suede', 'pictures/image-340055.jpeg', 'camisola', 21),
    new Item('Camisola manga algodão', 'pictures/image-360055.jpeg', 'camisola', 22),
    new Item('Calcinhas LOL - Kit', 'pictures/image-370055.jpeg', 'calcinha', 25),
    new Item('Calça lateral com renda', 'pictures/image-380055.jpeg', 'calça', 8.5),
    new Item('Babydoll americano infantil Suede', 'pictures/image-390055.jpeg', 'babydoll', 28),
    ...
    new Item('Calça coton cós virado', 'pictures/image-430055.jpeg', 'calça', 7),
    new Item('Calça coton pala', 'pictures/image-440055.jpeg', 'calça', 7),
    new Item('Calça box', 'pictures/image-450055.jpeg', 'calça', 8),
    new Item('Calça conforto', 'pictures/image-460055.jpeg', 'calça', 7.5),
    new Item('Fio duplo', 'pictures/image-470055.jpeg', 'fio', 6),
    new Item('Calça plus reforçada', 'pictures/image-480055.jpeg', 'calça', 18),
    new Item('Fio rendado', 'pictures/image-490055.jpeg', 'fio', 7.5),
    new Item('Calça drapeada', 'pictures/image-500055.jpeg', 'calça', 8.5),
    new Item('Cueca box infantil', 'pictures/image-510055.jpeg', 'cueca', 5.5),
    new Item('Calça infantil algodão', 'pictures/image-520055.jpeg', 'calça', 5),
    new Item('Calça infantil microfibra', 'pictures/image-530055.jpeg', 'calça', 5),
    new Item('Short segunda pele', 'pictures/image-540055.jpeg', 'short', 15),
    new Item('Sutiã reforçado setinete', 'pictures/image-550055.jpeg', 'sutiã', 28),
    new Item('Calça cinta', 'pictures/image-560055.jpeg', 'calça', 21),
    new Item('Calça reforçada', 'pictures/image-570055.jpeg', 'calça', 13),
    ...
    new Item('Calça algodão', 'pictures/image-640055.jpeg', 'calça', 7.5),
    new Item('Calça pala microfibra', 'pictures/image-650055.jpeg', 'calça', 8.5),
    new Item('Babydoll Suede adulto', 'pictures/image-660055.jpeg', 'babydoll', 15),
    new Item('Babydoll Suede infantil', 'pictures/image-670055.jpeg', 'babydoll', 10),
    ...
    new Item('Calça pala dupla', 'pictures/image-780055.jpeg', 'calça', 7.5),
    new Item('Tanga microfibra', 'pictures/image-790055.jpeg', 'tanga', 5),
    new Item('Calça infantil', 'pictures/image-800055.jpeg', 'calça', 4.5),
    ...
    new Item('Cueca box poliéster adulto', 'pictures/image-900055.jpeg', 'cueca', 8),
    new Item('Calça microfibra plus', 'pictures/image-910055.jpeg', 'calça', 11),
    new Item('Cueca box infantil poliéster', 'pictures/image-920055.jpeg', 'cueca', 5.5),
